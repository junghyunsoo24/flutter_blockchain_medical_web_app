...
import 'package:portfolio_flutter_blockchain_medical_web_app/api/diagnosis/diagnosis_request.dart';

import '../../database/drift_database.dart';
import '../../login/view/login_screen.dart';

class Diagnosis extends ConsumerStatefulWidget{
...
class _DiagnosisState extends ConsumerState<Diagnosis>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('$userName님 진료 내용', style: TextStyle(fontWeight: FontWeight.bold)),
      ),
      body: healthChecks.isEmpty
          ? Center(child: Text('진료 내용이 없습니다.'))
          : ListView.builder(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => DiagnosisRequest()),
          );
        },
        child: Column(
