              ...
              onPressed: () {
                ...
                if (content.isNotEmpty) {
                  ...
                  if (Platform.isWindows) {
                    _commentViewModel.addComment(widget.questionId, content, doctorInfo.userId);
          ...
          builder: (context, child) {
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final isOwnComment = comment.userId == (Platform.isWindows ? doctorInfo.userId : userInfo.userId);
                return Stack(
                  children: [
                    ListTile(
