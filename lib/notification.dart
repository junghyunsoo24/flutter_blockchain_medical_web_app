...
class FlutterLocalNotification {
  ...
  static Future<void> showNotification() async {
    ...
    await flutterLocalNotificationsPlugin.show(0, 'test title', 'test body', notificationDetails, payload: "HELLOWORLD");
  }

  //oreground 상태(앱이 열린 상태에서 받은 경우)
  static void onDidReceiveNotificationResponse(NotificationResponse notificationResponse) async {//Payload(전송 데이터)를 Stream에 추가
  ...
  static void onBackgroundNotificationResponse() async {
    ...
    //앱이 Notification을 통해서 열린 경우라면 Payload(전송 데이터)를 Stream에 추가
